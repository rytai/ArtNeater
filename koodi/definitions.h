...
//########################## Pin define #####################
const unsigned int PIN_ENCODER_CLK = 9;  // Connected to CLK on KY-040
const unsigned int PIN_ENCODER_DT = 10;  // Connected to DT on KY-040
const unsigned int PIN_ENCODER_BUTTON = 14;  // Connected to SW on KY-040"
/*
